...
public abstract class BusDataProvider {
	...
	public static final GetterBusData ACCUMULATOR = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
		return cpu.getAC();
	};
	
	public static final GetterBusData ABSOLUTE = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
		return bus.getCell((short) (cpu.nextPC() | (cpu.nextPC() << 8)));
	};
	
	public static final GetterBusData ABSOLUTE_X = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
	...
	public static final GetterBusData ABSOLUTE_Y = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
	...
	public static final GetterBusData IMMEDIATE = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
		return cpu.nextCellPC();
	};
	
	public static final GetterBusData IMPLIED = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
		return null;
	};
	
	public static final GetterBusData INDIRECT	 = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
		short adr = (short) (cpu.nextPC() | (cpu.nextPC() << 8));
		return bus.getCell((short) (bus.read(adr) | (bus.read((short) (adr + 1)) << 8)));
	};
	
	public static final GetterBusData INDIRECT_X = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
		short adr = (byte) (cpu.nextPC() + cpu.getX());
		return bus.getCell((short) (bus.read(adr) | (bus.read((short) (adr + 1)) << 8)));
	};	
	
	public static final GetterBusData INDIRECT_Y = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
	...
	*/
	...
	public static final GetterBusData ZEROPAGE_X = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
		return bus.getCell((short) (Byte.toUnsignedInt(cpu.nextPC()) + Byte.toUnsignedInt(cpu.getX())));
	};
	
	public static final GetterBusData ZEROPAGE_Y = (Opcode2A03 op, Cpu2A03 cpu, Bus2A03 bus) -> {
